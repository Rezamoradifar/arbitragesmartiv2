...
const NEW_ITEMS = [
  {
    id: "blacklist-cannot-freeze-principal",
    category: "Security",
    text: "Blacklisting an address blocks new stakes, top-ups, plan upgrades, and claiming yield or referral rewards — but it cannot touch early exit or emergency withdrawal. A blacklisted user's principal can never be permanently frozen by this flag; the two paths back to your own money are carved out of the owner's reach entirely.\n\n#ArbiSmart #Polygon #USDT #Security",
  },
  {
    id: "claim-fee-halves-for-higher-tiers",
    category: "Transparency",
    text: "The fee charged on claiming yield isn't the same across all plans — Advanced and Elite stakers pay half what the entry-level tiers pay. Committing to a bigger, longer position doesn't just earn a higher rate; it also costs less to actually collect what you've earned.\n\n#ArbiSmart #Polygon #USDT #Transparency",
  },
];
...
const SCRATCH = `${tmpdir()}/telegram-card-render-batch30-${Date.now()}`;
