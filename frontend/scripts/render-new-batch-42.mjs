...
const NEW_ITEMS = [
  {
    id: "owner-is-structural-minority-in-emergency-vote",
    category: "Security",
    text: "The owner holds exactly one vote out of up to five in the emergency-mode governance body — the same as any partner. Three partners can trigger emergency mode over the owner's own objection, and the owner alone can neither force it through nor block it once it's moving. That's not a courtesy; it's the vote count.\n\n#ArbiSmart #Polygon #USDT #Security",
  },
  {
    id: "protocol-wallets-pay-full-fee-no-exemption",
    category: "Transparency",
    text: "The two development-fee wallets are locked to a single, exact position size — 1,000 USDT, no more, no less — and they pay the deposit fee on it exactly the same as any other depositor. No carve-out, no fee-free treatment for the wallets that collect the platform's own revenue.\n\n#ArbiSmart #Polygon #USDT #Transparency",
  },
];
...
const SCRATCH = `${tmpdir()}/telegram-card-render-batch42-${Date.now()}`;
