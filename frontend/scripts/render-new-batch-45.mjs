...
const NEW_ITEMS = [
  {
    id: "two-token-architecture-collateral-vs-arbitrage",
...
const SCRATCH = `${tmpdir()}/telegram-card-render-batch45-${Date.now()}`;
