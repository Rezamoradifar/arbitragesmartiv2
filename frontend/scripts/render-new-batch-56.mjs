...
const NEW_ITEMS = [
  {
    id: "deposit-totals-stay-queryable-after-exit-forever",
    category: "Transparency",
    text: "Your gross deposited, platform fee paid, and net staked figures are permanent counters that never reset to zero — even after you exit for good and your active stake drops to nothing, those three numbers stay exactly as they were, forever readable by anyone who calls the contract with your address.\n\n#ArbiSmart #Polygon #USDT #Transparency",
  },
  {
    id: "topup-doesnt-reset-early-exit-penalty-clock",
    category: "Staking",
    text: "Topping up an existing position doesn't restart your early-exit penalty timer — the penalty schedule is measured from your stake's ORIGINAL start time, which a top-up never touches. Add funds to a position you opened weeks ago, and the whole thing — old and new capital alike — exits at whatever discount your original stake had already earned.\n\n#ArbiSmart #Polygon #USDT #Staking",
  },
];
...
const SCRATCH = `${tmpdir()}/telegram-card-render-batch56-${Date.now()}`;
