...
const NEW_ITEMS = [
  {
    id: "direct-downline-roster-publicly-queryable",
    category: "Transparency",
    text: "Anyone can call a public view function and get back every one of your direct referrals by address, along with each one's exact stake size and plan — not just the aggregate volume number. Your downline roster isn't a private dashboard figure; it's readable on-chain by anyone who knows your address.\n\n#ArbiSmart #Polygon #USDT #Transparency",
  },
  {
    id: "second-third-level-downline-named-not-just-counted",
    category: "Transparency",
    text: "An earlier version only ever exposed your direct referral level by name — the two levels above where your yield actually comes from were just a number with nobody attached. This version writes out full address lists for those levels too, so 'who's actually in my second and third level' has a real answer, not just a count.\n\n#ArbiSmart #Polygon #USDT #Transparency",
  },
];
...
const SCRATCH = `${tmpdir()}/telegram-card-render-batch52-${Date.now()}`;
