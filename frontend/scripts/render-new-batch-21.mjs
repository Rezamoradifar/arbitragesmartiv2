...
const NEW_ITEMS = [
  {
    id: "identical-tokens-rejected-at-deploy",
    category: "Security",
...
const SCRATCH = `${tmpdir()}/telegram-card-render-batch21-${Date.now()}`;
