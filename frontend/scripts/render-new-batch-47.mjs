...
const NEW_ITEMS = [
  {
    id: "referral-can-start-countable-after-topup",
    category: "Referral",
    text: "A referral who first stakes below the countable floor isn't locked out forever — if a later top-up pushes their position over that threshold, they start counting toward your headcount at that moment. The check isn't a one-time gate at the first deposit; it re-evaluates every time a referral adds to their stake.\n\n#ArbiSmart #Polygon #USDT #Referral",
  },
  {
    id: "plan-upgrade-rate-applies-retroactively",
    category: "Staking",
    text: "Upgrading your plan doesn't just change your rate going forward — because unclaimed yield is calculated from your last claim using whatever rate is stored right now, upgrading applies the new, higher daily rate to your entire unclaimed period since your last claim, not only to time after the upgrade.\n\n#ArbiSmart #Polygon #USDT #Staking",
  },
];
...
const SCRATCH = `${tmpdir()}/telegram-card-render-batch47-${Date.now()}`;
